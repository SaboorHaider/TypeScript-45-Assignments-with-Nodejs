...
//Creating a Array
let gustList = ["Ali", "Haider", "Salar", "HIzzer"];

//Making variable for those guest who cant come
let dontCome = gustList[1];
...
gustList.forEach(oneguest => console.log(`Hello! ${oneguest}, would you like to dinner with me `));
...
gustList.forEach(invites => console.log(`Luckly ${invites}, You are still invited to the dinner.`))
