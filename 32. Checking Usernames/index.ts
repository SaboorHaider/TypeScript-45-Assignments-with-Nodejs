...
// Array of Current Users
 let currentUser = [ "Ali" , "Raza" , "Saboor" , "Ammar" , "Abbas"];

 // Array of New Users
let newUsers = ["Salar" , "Haider" , "Raza" , "Zaid" , "Ammar"];
...
//Mking a Condition for username already exist and save in our condition variable
    let ourCondition = currentUser.some(current_one_user => current_one_user.toLocaleLowerCase() === new_one_user.toLocaleLowerCase());
